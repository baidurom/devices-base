...
.method private mtkPostscan([Ljava/lang/String;)V
    .locals 26
    .parameter "directories"
    ...
    const-string/jumbo v23, "mtkPostscan>>>"
    ...
    .line 1333
    .local v5, deleteRowIds:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    new-instance v14, Ljava/util/ArrayList;

    invoke-direct {v14, v11}, Ljava/util/ArrayList;-><init>(I)V

    .line 1334
    .local v14, playListRowIds:Ljava/util/List;,"Ljava/util/List<Ljava/lang/String;>;"
    const/16 v21, 0x0
    ...
    .line 1337
    .local v4, bulkUri:Landroid/net/Uri;
    move-object/from16 v0, p0
    ...
    .line 1338
    .local v9, iterator:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/media/MediaScanner$FileCacheEntry;>;"
    :cond_0
    :goto_0
    ...
    check-cast v6, Landroid/media/MediaScanner$FileCacheEntry;

    .line 1340
    .local v6, entry:Landroid/media/MediaScanner$FileCacheEntry;
    iget-object v13, v6, Landroid/media/MediaScanner$FileCacheEntry;->mPath:Ljava/lang/String;
    ...
    .line 1344
    .local v7, fileMissing:Z
    iget-boolean v0, v6, Landroid/media/MediaScanner$FileCacheEntry;->mSeenInFileSystem:Z

    move/from16 v22, v0

    if-nez v22, :cond_1

    iget v0, v6, Landroid/media/MediaScanner$FileCacheEntry;->mFormat:I
    ...
    invoke-direct {v0, v13, v1}, Landroid/media/MediaScanner;->inScanDirectory(Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    .line 1364
    iget-wide v0, v6, Landroid/media/MediaScanner$FileCacheEntry;->mRowId:J
    ...
    invoke-interface {v0, v4, v1, v2, v3}, Landroid/content/IContentProvider;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 1353
    .local v19, testFile:Ljava/io/File;
    ...
    .line 1361
    .end local v19           #testFile:Ljava/io/File;
    .restart local v12       #mediaFileType:Landroid/media/MediaFile$MediaFileType;
    :cond_3
    iget v8, v12, Landroid/media/MediaFile$MediaFileType;->fileType:I
    ...
    invoke-interface {v0, v4, v1, v2}, Landroid/content/IContentProvider;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string/jumbo v24, "mtkPostscan: delete "
    ...
    iget v0, v0, Landroid/media/MediaScanner;->mOriginalVideoCount:I
    ...
    invoke-static/range {v23 .. v23}, Landroid/provider/MediaStore$Images$Media;->getContentUri(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v23

    invoke-virtual/range {v22 .. v23}, Landroid/net/Uri;->equals(Ljava/lang/Object;)Z
    ...
    const-string/jumbo v24, "mtkPostscan: pruneDeadThumbnailFiles takes "
...
.method private mtkPrescan()V
    ...
    const-string/jumbo v16, "mtkPrescan>>>"
    ...
    iget-object v15, v0, Landroid/media/MediaScanner;->mFilesUri:Landroid/net/Uri;

    invoke-virtual {v15}, Landroid/net/Uri;->buildUpon()Landroid/net/Uri$Builder;

    move-result-object v15

    const-string v16, "isprescan"
    ...
    invoke-interface {v15, v9, v13, v14}, Landroid/content/IContentProvider;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string/jumbo v17, "mtkPrescan: deleted="
    ...
    iget-object v15, v0, Landroid/media/MediaScanner;->mContext:Landroid/content/Context;

    const-string/jumbo v16, "storage"
    ...
    const-string/jumbo v16, "mtkPrescan<<<Null volumeList!"
    ...
    .line 1442
    invoke-virtual {v11}, Landroid/os/storage/StorageVolume;->getStorageId()I
    ...
    const-string/jumbo v16, "mtkPrescan<<<storageId=0"
    ...
    .line 1454
    const-string/jumbo v13, "storage_id=?"
    ...
    .line 1456
    .restart local v14       #whereArgs:[Ljava/lang/String;
    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/media/MediaScanner;->mMediaProvider:Landroid/content/IContentProvider;

    invoke-interface {v15, v9, v10, v13, v14}, Landroid/content/IContentProvider;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string/jumbo v17, "mtkPrescan: updated="
    ...
    const-string/jumbo v17, "mtkPrescan<<<state="
...
.method private prescan(Ljava/lang/String;Z)V
    ...
    const-string/jumbo v3, "prescan>>>filePath="
    ...
    .line 1111
    invoke-direct/range {p0 .. p0}, Landroid/media/MediaScanner;->mtkPrescan()V
    ...
    const-string/jumbo v3, "prescan<<<imageCount="
...
.method public scanDirectories([Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1508
    .local v7, scan:J
    invoke-direct/range {p0 .. p1}, Landroid/media/MediaScanner;->mtkPostscan([Ljava/lang/String;)V
