...
.field private static final KEYGUARD_RELAYOUT:I = 0xe
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mExternallyEnabled:Z

    .line 231
    sput-boolean v1, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowing:Z

    .line 234
    sput-boolean v1, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mHidden:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/policy/impl/PhoneWindowManager;Landroid/os/LocalPowerManager;)V
    ...
    .line 179
    iput-boolean v10, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mChecked:Z
    ...
    .line 276
    iput v10, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowCount:I
    ...
    invoke-virtual {v0, p0}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->registerDeviceInfoCallback(Lcom/android/internal/policy/impl/KeyguardUpdateMonitor$deviceInfoCallback;)V
...
.method static synthetic access$1100(Lcom/android/internal/policy/impl/KeyguardViewMediator;Lcom/android/internal/policy/impl/KeyguardViewManager$ShowListener;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1300(Lcom/android/internal/policy/impl/KeyguardViewMediator;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1600(Lcom/android/internal/policy/impl/KeyguardViewMediator;Z)V
    ...
    .prologue
    .line 101
    invoke-direct {p0, p1}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->handleKeyguardReLayout(Z)V

    return-void
.end method

.method static synthetic access$200(Lcom/android/internal/policy/impl/KeyguardViewMediator;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$202(Lcom/android/internal/policy/impl/KeyguardViewMediator;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$400()Z
    ...
    .prologue
    .line 101
    sget-boolean v0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mExternallyEnabled:Z
...
.method private adjustStatusBarLocked()V
    ...
    .line 1358
    sget-boolean v2, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowing:Z
    ...
    invoke-virtual {v2}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->isStatusBarExpandEnbale()Z
    ...
    sget-boolean v4, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowing:Z
    ...
    sget-boolean v4, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mHidden:Z
...
.method private adjustUserActivityLocked()V
    ...
    const-string v4, "adjustUserActivityLocked mShowing: "
    ...
    sget-boolean v2, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mHidden:Z
...
.method private adjustUserActivityLockedByShow()V
    .locals 5
    ...
    .local v0, enabled:Z
    :goto_0
    iget v2, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowCount:I
    ...
    const-string v3, "we firstset enableUserActivity,enabled="
    ...
    const-string v3, "we will set the enableUserActivity enabled="
...
.method private handleHide()V
    ...
    .line 1302
    :cond_0
    sget-boolean v0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowing:Z
    ...
    sput-boolean v0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowing:Z
...
.method private handleKeyguardReLayout(Z)V
    ...
    const-string v1, "handleKeyguardReLayout"
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/policy/impl/KeyguardViewManager;->reLayoutScreen(Z)V
...
.method private handleSetHidden(Z)V
    ...
    .line 583
    :try_start_0
    sget-boolean v0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mHidden:Z

    if-eq v0, p1, :cond_0

    .line 584
    sput-boolean p1, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mHidden:Z
...
.method private handleShow()V
    ...
    :cond_1
    :try_start_1
    iget v0, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowCount:I

    add-int/lit8 v0, v0, 0x1

    iput v0, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowCount:I
    ...
    const-string v2, "handleShow, count="
...
.method private handleTimeout(I)V
    ...
    const-string v2, "handleTimeout, seq="
    ...
    const-string v2, ", mWakelockSequence="
...
.method public static isKeyguardNotShowing()Z
    ...
    sget-boolean v2, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mExternallyEnabled:Z
...
.method private showLocked()V
    ...
    .line 770
    .local v0, msg:Landroid/os/Message;
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->isAlarmBoot()Z

    move-result v1

    if-eqz v1, :cond_0

    iget-boolean v1, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mChecked:Z
    ...
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mChecked:Z

    .line 772
    const-string v1, "KeyguardViewMediator"

    const-string v2, "it\'s alarm boot, delay 3s to show"
...
# virtual methods
.method public DM_Check_Locked()Z
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->DM_IsLocked()Z
...
.method public doKeyguardLocked()V
    ...
    .line 634
    const-string v10, "persist.sys.monkey"
    ...
    .line 639
    :cond_0
    sget-boolean v10, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mExternallyEnabled:Z

    if-nez v10, :cond_1

    iget-object v10, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mUpdateMonitor:Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;

    invoke-virtual {v10}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->DM_IsLocked()Z
    ...
    .line 655
    :cond_1
    iget-object v10, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mKeyguardViewManager:Lcom/android/internal/policy/impl/KeyguardViewManager;

    invoke-virtual {v10}, Lcom/android/internal/policy/impl/KeyguardViewManager;->isShowing()Z
    ...
    invoke-virtual {v10}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->isDeviceProvisioned()Z
    ...
    invoke-virtual {v10, v9}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->getSimState(I)Lcom/android/internal/telephony/IccCard$State;

    move-result-object v6

    .line 665
    .local v6, state:Lcom/android/internal/telephony/IccCard$State;
    iget-object v10, p0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mUpdateMonitor:Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;

    invoke-virtual {v10, v8}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->getSimState(I)Lcom/android/internal/telephony/IccCard$State;

    move-result-object v7

    .line 666
    .local v7, stateGemini:Lcom/android/internal/telephony/IccCard$State;
    ...
    :goto_2
    invoke-virtual {v7}, Lcom/android/internal/telephony/IccCard$State;->isPinLocked()Z
    ...
    .line 675
    .local v3, lockedOrMissingGemini:Z
    :goto_3
    if-nez v2, :cond_5
    ...
    const-string v10, "lockedOrMissing is "
    ...
    const-string v10, ", keyguardisable="
    ...
    .end local v1           #keyguardisable:Z
    .end local v2           #lockedOrMissing:Z
    .end local v3           #lockedOrMissingGemini:Z
    .end local v4           #provisioned:Z
    .end local v5           #requireSim:Z
    .end local v6           #state:Lcom/android/internal/telephony/IccCard$State;
    .end local v7           #stateGemini:Lcom/android/internal/telephony/IccCard$State;
    :cond_6
    move v5, v9
    ...
    .restart local v6       #state:Lcom/android/internal/telephony/IccCard$State;
    .restart local v7       #stateGemini:Lcom/android/internal/telephony/IccCard$State;
    :cond_7
    move v2, v9
    ...
    .restart local v3       #lockedOrMissingGemini:Z
    :cond_9
    move v2, v9
    ...
    .line 689
    .restart local v1       #keyguardisable:Z
    :cond_a
    if-eqz v1, :cond_b
...
.method public keyguardDone(ZZ)V
    ...
    sput-boolean v1, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mExternallyEnabled:Z
...
.method public onScreenTurnedOff(I)V
    ...
    iget-object v0, v0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mKeyguardViewManager:Lcom/android/internal/policy/impl/KeyguardViewManager;

    move-object/from16 v18, v0

    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mScreenOn:Z

    move/from16 v19, v0

    invoke-virtual/range {v18 .. v19}, Lcom/android/internal/policy/impl/KeyguardViewManager;->setScreenStatus(Z)V
    ...
    .line 383
    sget-boolean v18, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mExternallyEnabled:Z
    ...
    :cond_3
    sget-boolean v18, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowing:Z
    ...
    .line 423
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->doKeyguardLocked()V
...
.method public onScreenTurnedOn(Lcom/android/internal/policy/impl/KeyguardViewManager$ShowListener;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/policy/impl/KeyguardViewManager;->setScreenStatus(Z)V
...
.method public onSimStateChanged(Lcom/android/internal/telephony/IccCard$State;)V
    ...
    .line 803
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->doKeyguardLocked()V
    ...
    invoke-virtual {v1, v2}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->getLastSimState(I)Lcom/android/internal/telephony/IccCard$State;
...
.method public onSimStateChangedGemini(Lcom/android/internal/telephony/IccCard$State;I)V
    ...
    const-string v1, "INTENT_VALUE_ICC_ABSENT and keygaurd isn\'t showing, we need to show the keyguard since the device isn\'t provisioned yet."
    ...
    invoke-virtual {v0, p2, v1}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->getPINDismissFlag(IZ)Z
    ...
    const-string v1, "We have dismissed PIN, so, we exit from PINPUK_REQUIRED"
    ...
    const-string v1, "We have dismissed PUK, so, we exit from PINPUK_REQUIRED"
    ...
    invoke-virtual {v1, p2}, Lcom/android/internal/policy/impl/KeyguardUpdateMonitor;->getLastSimState(I)Lcom/android/internal/telephony/IccCard$State;
...
.method public setKeyguardEnabled(Z)V
    ...
    .line 466
    sput-boolean p1, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mExternallyEnabled:Z

    .line 468
    if-nez p1, :cond_2

    sget-boolean v1, Lcom/android/internal/policy/impl/KeyguardViewMediator;->mShowing:Z
