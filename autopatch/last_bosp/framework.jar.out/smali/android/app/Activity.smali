...
.field static isCUConfirmed:Z

.field static final isCUVersion:Z
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/app/Activity;->isCUVersion:Z

    .line 4688
    sput-boolean v2, Landroid/app/Activity;->isCUConfirmed:Z
...
.method static synthetic access$400(Landroid/app/Activity;Landroid/content/Intent;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    .line 635
    invoke-direct {p0, p1, p2}, Landroid/app/Activity;->startActivityForResult_CU(Landroid/content/Intent;I)V

    return-void
.end method

.method private checkLauncherCategory(Ljava/util/Set;)Z
    .locals 4
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private startActivityForResult_CU(Landroid/content/Intent;I)V
    .locals 8
    .parameter "intent"
...
.method checkCUApplication(Landroid/content/Intent;I)Z
    .locals 9
    .parameter "intent"
    .parameter "requestCode"
    ...
    const-string v7, "com.sinovatech.unicom.ui"

    aput-object v7, v0, v5

    const-string v7, "com.infinit.wostore.ui"
    ...
    const-string v8, "com.asiainfo.android.MainActivity"

    aput-object v8, v0, v7

    .line 4698
    .local v0, classCUApplication:[Ljava/lang/String;
    ...
    invoke-direct {p0, v7}, Landroid/app/Activity;->checkLauncherCategory(Ljava/util/Set;)Z
    ...
    sget-boolean v7, Landroid/app/Activity;->isCUVersion:Z

    if-eqz v7, :cond_0

    sget-boolean v7, Landroid/app/Activity;->isCUConfirmed:Z
    ...
    invoke-virtual {p0, p0}, Landroid/app/Activity;->isCUDataConnection(Landroid/app/Activity;)Z
    ...
    new-instance v7, Landroid/app/Activity$3;

    invoke-direct {v7, p0}, Landroid/app/Activity$3;-><init>(Landroid/app/Activity;)V
    ...
    new-instance v8, Landroid/app/Activity$2;

    invoke-direct {v8, p0, p1, p2}, Landroid/app/Activity$2;-><init>(Landroid/app/Activity;Landroid/content/Intent;I)V
    ...
    new-instance v8, Landroid/app/Activity$1;

    invoke-direct {v8, p0}, Landroid/app/Activity$1;-><init>(Landroid/app/Activity;)V
...
.method isCUDataConnection(Landroid/app/Activity;)Z
    .locals 6
    .parameter "activity"
    ...
    .line 4775
    .local v1, con:Landroid/net/ConnectivityManager;
    if-nez v1, :cond_1
...
.method public startActivityForResult(Landroid/content/Intent;I)V
    ...
    .prologue
    .line 3210
    invoke-virtual {p0, p1, p2}, Landroid/app/Activity;->checkCUApplication(Landroid/content/Intent;I)Z
