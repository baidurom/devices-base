...
.method declared-synchronized add(Lbaidu/net/rtp/AudioStream;Lbaidu/net/rtp/AudioCodec;I)V
    ...
    .line 155
    :try_start_1
    invoke-virtual {p1}, Lbaidu/net/rtp/RtpStream;->dup()I
    ...
    invoke-virtual {p1}, Lbaidu/net/rtp/RtpStream;->getRemoteAddress()Ljava/net/InetAddress;
    ...
    invoke-virtual {p1}, Lbaidu/net/rtp/RtpStream;->getRemotePort()I
    ...
    const-string/jumbo v3, "local address = "

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    invoke-virtual {p1}, Lbaidu/net/rtp/RtpStream;->getLocalAddress()Ljava/net/InetAddress;
    ...
    const-string/jumbo v3, "local port = "

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    invoke-virtual {p1}, Lbaidu/net/rtp/RtpStream;->getLocalPort()I
    ...
    .line 163
    invoke-virtual {p1}, Lbaidu/net/rtp/RtpStream;->getMode()I
