...
.method private loadParts(J)[Lcom/google/android/mms/pdu/PduPart;
    ...
    const-string/jumbo v4, "loadParts("
...
.method private persistData(Lcom/google/android/mms/pdu/PduPart;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    .line 767
    const-string v11, "MMSLog"

    const-string v12, "convert data from null to empty."
    ...
    invoke-direct {v12, v2, v4}, Lcom/google/android/mms/pdu/EncodedStringValue;-><init>(I[B)V
    ...
    invoke-virtual {v11, v0, v3, v12, v13}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string/jumbo v13, "unable to update "
    ...
    const-string v12, "Failed to open Input/Output stream."
    ...
    invoke-direct {v12, v4}, Lcom/google/android/mms/pdu/EncodedStringValue;-><init>([B)V
    ...
    const-string v12, "Failed to read/write data."
    ...
    const-string v12, "Read or write file failure."
    ...
    const-string v12, "Can\'t find data for this part."
    ...
    const-string v13, "Saving data to: "
...
.method public persist(Lcom/google/android/mms/pdu/GenericPdu;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    const-string/jumbo v6, "persist uri "
    ...
    const-string/jumbo v5, "persist update part begin "
    ...
    const-string/jumbo v5, "persist purge end "
