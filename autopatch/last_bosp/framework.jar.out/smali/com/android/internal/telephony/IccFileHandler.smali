...
.field protected static final RESPONSE_DATA_DF_NAME_TAG:I = 0x84

.field protected static final RESPONSE_DATA_FCP_TAG:I = 0x62

.field protected static final RESPONSE_DATA_FILE_DESCRIPTOR_TAG:I = 0x82

.field protected static final RESPONSE_DATA_FILE_IDENTIFIER_TAG:I = 0x83
...
.field protected static final RESPONSE_DATA_FILE_SIZE_TAG:I = 0x80
...
.field protected static final RESPONSE_DATA_LIFE_CYCLE_TAG:I = 0x8a

.field protected static final RESPONSE_DATA_PROPRIETARY_INFO_TAG:I = 0xa5
...
.field protected static final RESPONSE_DATA_SECURITY_ATTRI_1_TAG:I = 0x8b

.field protected static final RESPONSE_DATA_SECURITY_ATTRI_2_TAG:I = 0x8c

.field protected static final RESPONSE_DATA_SECURITY_ATTRI_3_TAG:I = 0xab

.field protected static final RESPONSE_DATA_SHORT_FILE_IDENTIFIER_TAG:I = 0x88

.field protected static final RESPONSE_DATA_STRUCTURE:I = 0xd

.field protected static final RESPONSE_DATA_TOTAL_FILE_SIZE_TAG:I = 0x81
...
.method public getEFLinearRecordSize(ILandroid/os/Message;)V
    ...
    invoke-direct {v2, p1, p2}, Lcom/android/internal/telephony/IccFileHandler$LoadLinearFixedContext;-><init>(ILandroid/os/Message;)V
    ...
    invoke-virtual {v0}, Lcom/android/internal/telephony/IccCard;->isUsimCard()Z
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/IccCard;->isUsimCard()Z
    ...
    .line 467
    new-instance v30, Lcom/android/internal/telephony/gsm/SimTlv;
    ...
    invoke-direct {v0, v1, v3, v4}, Lcom/android/internal/telephony/gsm/SimTlv;-><init>([BII)V

    .line 468
    .local v30, tlv:Lcom/android/internal/telephony/gsm/SimTlv;
    invoke-virtual/range {v30 .. v30}, Lcom/android/internal/telephony/gsm/SimTlv;->getTag()I
    ...
    .line 470
    const-string/jumbo v3, "parse RESPONSE_DATA_FCP_TAG error"
    ...
    .line 475
    :cond_3
    new-instance v31, Lcom/android/internal/telephony/gsm/SimTlv;

    invoke-virtual/range {v30 .. v30}, Lcom/android/internal/telephony/gsm/SimTlv;->getData()[B
    ...
    invoke-direct {v0, v3, v4, v6}, Lcom/android/internal/telephony/gsm/SimTlv;-><init>([BII)V

    .line 476
    .local v31, tlvFCP:Lcom/android/internal/telephony/gsm/SimTlv;
    :goto_1
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/telephony/gsm/SimTlv;->isValidObject()Z
    ...
    .line 478
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/telephony/gsm/SimTlv;->getTag()I
    ...
    .line 480
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/telephony/gsm/SimTlv;->getData()[B
    ...
    .line 482
    const-string v3, "FILE_DESCRIPTOR length error "
    ...
    .line 488
    .local v23, hexdata:Ljava/lang/String;
    const/4 v3, 0x0
    ...
    const-string v4, "ICCIO get recordsize: recordSize[0]:"
    ...
    .line 476
    .end local v23           #hexdata:Ljava/lang/String;
    :cond_5
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/telephony/gsm/SimTlv;->nextObject()Z

    goto/16 :goto_1

    .line 503
    .end local v30           #tlv:Lcom/android/internal/telephony/gsm/SimTlv;
    .end local v31           #tlvFCP:Lcom/android/internal/telephony/gsm/SimTlv;
    :cond_6
    const/4 v3, 0x4
    ...
    .line 543
    .restart local v30       #tlv:Lcom/android/internal/telephony/gsm/SimTlv;
    invoke-virtual/range {v30 .. v30}, Lcom/android/internal/telephony/gsm/SimTlv;->getTag()I
    ...
    .line 551
    .restart local v31       #tlvFCP:Lcom/android/internal/telephony/gsm/SimTlv;
    :goto_2
    invoke-virtual/range {v31 .. v31}, Lcom/android/internal/telephony/gsm/SimTlv;->isValidObject()Z
    ...
    .line 563
    .restart local v23       #hexdata:Ljava/lang/String;
    const/4 v3, 0x4
    ...
    const-string v4, "ICCIO getresponse: recordsize:"
    ...
    const-string v4, "ICCIO getresponse: binary Filesize:"
    ...
    invoke-virtual {v0, v12, v5, v13, v1}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public loadEFImgTransparent(IIIILandroid/os/Message;)V
    ...
    invoke-virtual {p0, v0, p1, v1, p5}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
...
.method public loadEFLinearFixed(IILandroid/os/Message;)V
    ...
    invoke-direct {v2, p1, p2, p3}, Lcom/android/internal/telephony/IccFileHandler$LoadLinearFixedContext;-><init>(IILandroid/os/Message;)V
...
.method public loadEFLinearFixedPart(ILjava/util/ArrayList;Landroid/os/Message;)V
    ...
    invoke-direct {v2, p1, p2, p3}, Lcom/android/internal/telephony/IccFileHandler$LoadLinearFixedContext;-><init>(ILjava/util/ArrayList;Landroid/os/Message;)V
