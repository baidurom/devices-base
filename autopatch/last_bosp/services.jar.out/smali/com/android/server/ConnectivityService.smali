...
.field private static final USB_INTERFACE:Ljava/lang/String; = "usb0"
...
.field private synchronizedObject:Ljava/lang/Object;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/ConnectivityService;->mScreenOn:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    .line 625
    .local v29, optr:Ljava/lang/String;
    ...
    iput-object v2, v0, Lcom/android/server/ConnectivityService;->synchronizedObject:Ljava/lang/Object;
    ...
    .end local v29           #optr:Ljava/lang/String;
    :cond_19
    const/4 v2, 0x0
...
.method static synthetic access$2801(Lcom/android/server/ConnectivityService;Z)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$3200(Lcom/android/server/ConnectivityService;)Lcom/android/server/connectivity/Vpn;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3500(Lcom/android/server/ConnectivityService;)Landroid/net/ProxyProperties;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3700(Lcom/android/server/ConnectivityService;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3800(Lcom/android/server/ConnectivityService;)Ljava/lang/Object;
    ...
    .prologue
    .line 140
    iget-object v0, p0, Lcom/android/server/ConnectivityService;->synchronizedObject:Ljava/lang/Object;

    return-object v0
.end method

.method static synthetic access$3900(Lcom/android/server/ConnectivityService;Ljava/lang/Long;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 140
    invoke-direct {p0, p1}, Lcom/android/server/ConnectivityService;->handleMobileDataConnectionChange(Ljava/lang/Long;)V
...
.method static synthetic access$4002(Z)Z
    ...
    .prologue
    .line 140
    sput-boolean p0, Lcom/android/server/ConnectivityService;->mScreenOn:Z
...
.method static synthetic access$500(Lcom/android/server/ConnectivityService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method private buildSimOverLimitIntent(J)Landroid/content/Intent;
    ...
    const-string v6, "com.android.systemui.net.NetworkOverLimitActivity"
    ...
    invoke-static {v4, p1, p2}, Landroid/provider/Telephony$SIMInfo;->getSlotById(Landroid/content/Context;J)I
    ...
    invoke-virtual {v3, v2}, Landroid/telephony/TelephonyManager;->getSubscriberIdGemini(I)Ljava/lang/String;
...
.method private handleDisconnect(Landroid/net/NetworkInfo;)V
    ...
    aget-object v22, v27, v23

    .line 1713
    .local v22, pids:Ljava/util/List;
    const/4 v8, 0x0
    ...
    .end local v22           #pids:Ljava/util/List;
    :cond_0
    ...
    .line 1738
    .local v16, mobileData:Z
    const-string v27, "ro.operator.optr"
    ...
    .line 1788
    invoke-static/range {v24 .. v24}, Landroid/net/ConnectivityManager;->isRadioNumValid(I)Z
    ...
    .line 1797
    .local v19, oldIface:Ljava/lang/String;
    ...
    .line 1799
    .local v18, networkStateTracker:Landroid/net/NetworkStateTracker;
    if-nez v18, :cond_e
    ...
    .end local v18           #networkStateTracker:Landroid/net/NetworkStateTracker;
    .end local v19           #oldIface:Ljava/lang/String;
    .restart local v16       #mobileData:Z
    ...
    invoke-direct {v0, v1}, Lcom/android/server/ConnectivityService;->isDataAvailable(I)Z

    move-result v4

    .line 1761
    .local v4, dataEnable:Z
    const/16 v27, -0x1
    ...
    invoke-virtual {v15}, Landroid/net/wifi/WifiManager;->hasConnectableAP()Z

    move-result v7

    .line 1764
    .local v7, hasConnectableAP:Z
    const-string v27, "CDS/Srv"

    new-instance v28, Ljava/lang/StringBuilder;

    invoke-direct/range {v28 .. v28}, Ljava/lang/StringBuilder;-><init>()V

    const-string v29, "hasConnectableAP:"
    ...
    const-string v29, "mobile data enable "
    ...
    const-string v29, ", mScreenOn "

    invoke-virtual/range {v28 .. v29}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v28

    sget-boolean v29, Lcom/android/server/ConnectivityService;->mScreenOn:Z
    ...
    sget-boolean v27, Lcom/android/server/ConnectivityService;->mScreenOn:Z
    ...
    const-string v27, "android.intent.action_WIFI_FAILOVER_GPRS_DIALOG"
    ...
    .line 1771
    .local v6, failoverIntent:Landroid/content/Intent;
    move-object/from16 v0, p0
    ...
    .line 1765
    .end local v6           #failoverIntent:Landroid/content/Intent;
    .end local v26           #wifiDisable:Z
    :cond_b
    const/16 v26, 0x0
    ...
    .line 1773
    .restart local v26       #wifiDisable:Z
    :cond_c
    move-object/from16 v0, p0
    ...
    .line 1800
    .end local v4           #dataEnable:Z
    .end local v7           #hasConnectableAP:Z
    ...
    .restart local v18       #networkStateTracker:Landroid/net/NetworkStateTracker;
    .restart local v19       #oldIface:Ljava/lang/String;
    :cond_e
    ...
    .line 1803
    .local v12, l:Landroid/net/LinkProperties;
    if-eqz v12, :cond_7
    ...
    .end local v3           #arr$:[Landroid/net/NetworkStateTracker;
    .end local v9           #i$:I
    .end local v12           #l:Landroid/net/LinkProperties;
    .end local v13           #len$:I
    ...
    .line 1817
    .local v10, immediateIntent:Landroid/content/Intent;
    ...
    invoke-direct {v0, v10}, Lcom/android/server/ConnectivityService;->sendStickyBroadcast(Landroid/content/Intent;)V
    ...
    invoke-direct {v0, v11, v1}, Lcom/android/server/ConnectivityService;->sendStickyBroadcastDelayed(Landroid/content/Intent;I)V
...
.method private handleMobileDataConnectionChange(Ljava/lang/Long;)V
    .locals 17
    .parameter "simID"

    .prologue
    invoke-direct/range {p0 .. p1}, Lcom/android/server/ConnectivityService;->prehandleDataConnChange(Ljava/lang/Long;)Z
    ...
    .line 3642
    .local v9, preSimID:Ljava/lang/Long;
    ...
    invoke-interface {v13, v14, v15}, Landroid/net/INetworkPolicyManager;->isDataConnOverLimit(J)Z
    ...
    invoke-direct {v0, v14, v15}, Lcom/android/server/ConnectivityService;->buildSimOverLimitIntent(J)Landroid/content/Intent;
    ...
    invoke-static {v13, v14, v15}, Landroid/provider/Telephony$SIMInfo;->getSlotById(Landroid/content/Context;J)I

    move-result v10

    .line 3667
    .local v10, preSimSlot:I
    :try_start_1
    const-string v13, "CDS/Srv"
    ...
    .line 3682
    invoke-interface {v5, v1, v10}, Lcom/android/internal/telephony/ITelephony;->cleanupApnTypeGemini(Ljava/lang/String;I)I
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-interface {v5, v13, v12}, Lcom/android/internal/telephony/ITelephony;->enableApnTypeGemini(Ljava/lang/String;I)I
...
.method private stopUsingNetworkFeature(Lcom/android/server/ConnectivityService$FeatureUser;Z)I
    ...
    const-string v11, "Send com.android.mms.transaction.STOP"
    ...
    const-string v12, "com.android.mms.transaction.STOP"
...
.method private stopUsingNetworkFeatureGemini(Lcom/android/server/ConnectivityService$FeatureUser;Z)I
    ...
    .line 3496
    .local v5, pid:I
    iget v8, p1, Lcom/android/server/ConnectivityService$FeatureUser;->mUid:I

    .line 3497
    .local v8, uid:I
    iget v6, p1, Lcom/android/server/ConnectivityService$FeatureUser;->mRadioNum:I
    ...
    const-string v13, "stopUsingNetworkFeatureGemini for net "
    ...
    invoke-interface {v12, p1}, Ljava/util/List;->indexOf(Ljava/lang/Object;)I
    ...
    .line 3529
    .local v10, x:Lcom/android/server/ConnectivityService$FeatureUser;
    invoke-virtual {v10, p1}, Lcom/android/server/ConnectivityService$FeatureUser;->isSameUser(Lcom/android/server/ConnectivityService$FeatureUser;)Z
    ...
    .line 3531
    const-string v11, "stopUsingNetworkFeatureGemini: dup is found, ignoring"
    ...
    .line 3538
    .end local v3           #i$:Ljava/util/Iterator;
    .end local v10           #x:Lcom/android/server/ConnectivityService$FeatureUser;
    :cond_3
    invoke-virtual {p0, v4, v2}, Lcom/android/server/ConnectivityService;->convertFeatureToNetworkType(ILjava/lang/String;)I
    ...
    const-string v12, "stopUsingNetworkFeatureGemini: net "
    ...
    const-string v12, " no known tracker for used net type "
    ...
    invoke-direct {p0, v5, v11}, Lcom/android/server/ConnectivityService;->reassessPidDns(IZ)V
    ...
    const-string v12, "not tearing down special network - others still using it"
    ...
    invoke-virtual {v11, v6}, Landroid/net/MobileDataStateTracker;->teardownGemini(I)Z

    .line 3574
    :goto_2
    const-string v11, "enableMMS"
    ...
    const-string v12, "Send com.android.mms.transaction.STOP"
    ...
    const-string v12, " not a known feature - dropping"
    ...
    .line 3571
    :cond_8
    invoke-interface {v7}, Landroid/net/NetworkStateTracker;->teardown()Z
...
.method private tryFailover(I)V
    ...
    invoke-virtual {v1, v3}, Landroid/net/MobileDataStateTracker;->reconnectGemini(I)Z
...
.method private updateRoutes(Landroid/net/LinkProperties;Landroid/net/LinkProperties;Z)Z
    ...
    const-string v11, "addRouteToAddress for: "
...
.method public getDataActivedSubscriberId()Ljava/lang/String;
    ...
    .line 3786
    .local v3, subsId:Ljava/lang/String;
    const/4 v2, -0x1
    ...
    .line 3800
    .end local v3           #subsId:Ljava/lang/String;
    .local v4, subsId:Ljava/lang/String;
    :goto_0
    return-object v4

    .line 3790
    .end local v4           #subsId:Ljava/lang/String;
    .restart local v3       #subsId:Ljava/lang/String;
    :cond_0
    iget-object v6, p0, Lcom/android/server/ConnectivityService;->mContext:Landroid/content/Context;

    invoke-static {v6, v0, v1}, Landroid/provider/Telephony$SIMInfo;->getSlotById(Landroid/content/Context;J)I
    ...
    const-string v7, "getDataActivedSubscriberId simId:"
    ...
    invoke-virtual {v5, v2}, Landroid/telephony/TelephonyManager;->getSubscriberIdGemini(I)Ljava/lang/String;
    ...
    .line 3800
    .end local v3           #subsId:Ljava/lang/String;
    .restart local v4       #subsId:Ljava/lang/String;
    goto :goto_0
.end method
...
.method public getMobileDataEnabledGemini(J)Z
    ...
    .line 3778
    .local v0, dataEnabledSimId:J
    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "getMobileDataEnabledGemini dataEnabledSimId:"
...
.method public setMobileDataEnabledGemini(J)Z
    ...
    const-string v1, "setMobileDataEnabledGemini simId"
    ...
    invoke-direct {p0, v0}, Lcom/android/server/ConnectivityService;->handleMobileDataConnectionChange(Ljava/lang/Long;)V
...
.method public startUsingNetworkFeature(ILjava/lang/String;Landroid/os/IBinder;)I
    ...
    invoke-virtual {v15, v0, v6}, Landroid/os/Handler;->removeMessages(ILjava/lang/Object;)V
