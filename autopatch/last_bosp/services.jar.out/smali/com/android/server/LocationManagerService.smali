...
.method private _loadNetworkLocationAndGeocoderProvider()V
    ...
    iput-object v6, p0, Lcom/android/server/LocationManagerService;->mNetworkLocationProviderPackageName:Ljava/lang/String;
    ...
    iput-object v6, p0, Lcom/android/server/LocationManagerService;->mGeocodeProviderPackageName:Ljava/lang/String;
    ...
    const-string v8, "The time to get PackageName is: "
    ...
    .line 592
    new-instance v6, Lcom/android/server/location/LocationProviderProxy;

    iget-object v7, p0, Lcom/android/server/LocationManagerService;->mContext:Landroid/content/Context;

    const-string v8, "network"

    iget-object v9, p0, Lcom/android/server/LocationManagerService;->mNetworkLocationProviderPackageName:Ljava/lang/String;
    ...
    invoke-direct {v6, v7, v8, v9, v10}, Lcom/android/server/location/LocationProviderProxy;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Handler;)V

    iput-object v6, p0, Lcom/android/server/LocationManagerService;->mNetworkLocationProvider:Lcom/android/server/location/LocationProviderProxy;

    .line 594
    iget-object v6, p0, Lcom/android/server/LocationManagerService;->mNetworkLocationProvider:Lcom/android/server/location/LocationProviderProxy;
    ...
    const-string v8, "NetworkLocationProvider has been added to the LMS Time: "
    ...
    invoke-virtual {v2, v6, v11}, Landroid/content/pm/PackageManager;->resolveService(Landroid/content/Intent;I)Landroid/content/pm/ResolveInfo;
    ...
    iget-object v8, p0, Lcom/android/server/LocationManagerService;->mGeocodeProviderPackageName:Ljava/lang/String;

    invoke-direct {v6, v7, v8}, Lcom/android/server/location/GeocoderProxy;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v6, p0, Lcom/android/server/LocationManagerService;->mGeocodeProvider:Lcom/android/server/location/GeocoderProxy;
    ...
    const-string v8, "GeocodeProvider has been added to the LMS Time: "
    ...
    const-string v7, "ActualNetworkServiceName"
    ...
    const-string v7, "ActualNetworkServiceSucess"
    ...
    const-string v8, "Can not find the Network Location Provider Package mNetworkLocationProviderPackageName:"
    ...
    invoke-static {v7, v6}, Lcom/mediatek/xlog/Xlog;->e(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string v7, "ActualGeocoderServiceName"
    ...
    const-string v7, "ActualGeocoderServiceSucess"
    ...
    const-string v8, "Can not find the Geocoder Provider Package mGeocodeProviderPackageName:"
...
.method static synthetic access$2500(Lcom/android/server/LocationManagerService;)V
    .locals 0
    .parameter "x0"
