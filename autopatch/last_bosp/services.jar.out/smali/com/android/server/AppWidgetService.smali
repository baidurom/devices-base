...
.method private parseProviderInfoXml(Landroid/content/ComponentName;Landroid/content/pm/ResolveInfo;)Lcom/android/server/AppWidgetService$Provider;
    ...
    iget-object v15, v1, Landroid/content/pm/ComponentInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
...
.method addProvidersForPackageLocked(Ljava/lang/String;)V
    ...
    iget-object v6, v1, Landroid/content/pm/ComponentInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
...
.method notifyAppWidgetViewDataChangedInstanceLocked(Lcom/android/server/AppWidgetService$AppWidgetId;I)V
    ...
    iget-object v9, p1, Lcom/android/server/AppWidgetService$AppWidgetId;->provider:Lcom/android/server/AppWidgetService$Provider;

    if-eqz v9, :cond_2

    iget-object v9, p1, Lcom/android/server/AppWidgetService$AppWidgetId;->provider:Lcom/android/server/AppWidgetService$Provider;

    iget-boolean v9, v9, Lcom/android/server/AppWidgetService$Provider;->zombie:Z

    if-nez v9, :cond_2

    iget-object v9, p1, Lcom/android/server/AppWidgetService$AppWidgetId;->host:Lcom/android/server/AppWidgetService$Host;

    iget-boolean v9, v9, Lcom/android/server/AppWidgetService$Host;->zombie:Z
    ...
    iget-object v9, v9, Lcom/android/server/AppWidgetService$Host;->callbacks:Lcom/android/internal/appwidget/IAppWidgetHost;
    ...
    iget v10, p1, Lcom/android/server/AppWidgetService$AppWidgetId;->appWidgetId:I
    ...
    .line 826
    iget-object v9, p0, Lcom/android/server/AppWidgetService;->mRemoteViewsServicesAppWidgets:Ljava/util/HashMap;
    ...
    .line 827
    .local v6, keys:Ljava/util/Set;,"Ljava/util/Set<Landroid/content/Intent$FilterComparison;>;"
    ...
    check-cast v5, Landroid/content/Intent$FilterComparison;

    .line 828
    .local v5, key:Landroid/content/Intent$FilterComparison;
    iget-object v9, p0, Lcom/android/server/AppWidgetService;->mRemoteViewsServicesAppWidgets:Ljava/util/HashMap;
    ...
    invoke-virtual {v9, v4, v0, v10}, Landroid/content/Context;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .end local v5           #key:Landroid/content/Intent$FilterComparison;
    .end local v6           #keys:Ljava/util/Set;,"Ljava/util/Set<Landroid/content/Intent$FilterComparison;>;"
    .end local v7           #token:J
    :catch_0
    move-exception v2

    .line 814
    .local v2, ex:Landroid/os/TransactionTooLargeException;
    const-string v9, "AppWidgetService"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string v11, "TransactionTooLargeException: "
    ...
    .line 816
    .end local v2           #ex:Landroid/os/TransactionTooLargeException;
    :catch_1
    move-exception v1
    ...
    iput-object v10, v9, Lcom/android/server/AppWidgetService$Host;->callbacks:Lcom/android/internal/appwidget/IAppWidgetHost;
    ...
    .restart local v5       #key:Landroid/content/Intent$FilterComparison;
    .restart local v6       #keys:Ljava/util/Set;,"Ljava/util/Set<Landroid/content/Intent$FilterComparison;>;"
...
.method updateAppWidgetInstanceLocked(Lcom/android/server/AppWidgetService$AppWidgetId;Landroid/widget/RemoteViews;Z)V
    ...
    iget-object v2, p1, Lcom/android/server/AppWidgetService$AppWidgetId;->host:Lcom/android/server/AppWidgetService$Host;

    iget-boolean v2, v2, Lcom/android/server/AppWidgetService$Host;->zombie:Z
    ...
    iget-object v2, v2, Lcom/android/server/AppWidgetService$Host;->callbacks:Lcom/android/internal/appwidget/IAppWidgetHost;
    ...
    iget v3, p1, Lcom/android/server/AppWidgetService$AppWidgetId;->appWidgetId:I

    invoke-interface {v2, v3, p2}, Lcom/android/internal/appwidget/IAppWidgetHost;->updateAppWidget(ILandroid/widget/RemoteViews;)V
    :try_end_0
    .catch Landroid/os/TransactionTooLargeException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    .line 790
    .local v1, ex:Landroid/os/TransactionTooLargeException;
    ...
    const-string v4, "TransactionTooLargeException: "
    ...
    .line 792
    .end local v1           #ex:Landroid/os/TransactionTooLargeException;
    :catch_1
    move-exception v0
    ...
    iput-object v3, v2, Lcom/android/server/AppWidgetService$Host;->callbacks:Lcom/android/internal/appwidget/IAppWidgetHost;
...
.method updateProvidersForPackageLocked(Ljava/lang/String;)V
    ...
    .line 1594
    .local v8, ex:Landroid/os/TransactionTooLargeException;
    const-string v17, "AppWidgetService"

    new-instance v18, Ljava/lang/StringBuilder;

    invoke-direct/range {v18 .. v18}, Ljava/lang/StringBuilder;-><init>()V

    const-string v19, "TransactionTooLargeException : "
    ...
    .line 1596
    .end local v8           #ex:Landroid/os/TransactionTooLargeException;
    :catch_1
    move-exception v8
