...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v3, "visual_lines"
...
.method constructor <init>(IZ)V
    ...
    .line 769
    iput v0, p0, Landroid/view/HardwareRenderer$GlRenderer;->mWidth:I

    iput v0, p0, Landroid/view/HardwareRenderer$GlRenderer;->mHeight:I

    .line 800
    iput v0, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileVisualizerType:I
...
.method draw(Landroid/view/View;Landroid/view/View$AttachInfo;Landroid/view/HardwareRenderer$HardwareDrawCallbacks;Landroid/graphics/Rect;)V
    ...
    .line 1353
    iget-boolean v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileEnabled:Z

    if-eqz v6, :cond_1

    .line 1354
    iget-object v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileLock:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v6}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    .line 1357
    :cond_1
    invoke-direct {p0, v0, p4, v5}, Landroid/view/HardwareRenderer$GlRenderer;->beginFrame(Landroid/view/HardwareCanvas;Landroid/graphics/Rect;I)Landroid/graphics/Rect;

    move-result-object p4

    .line 1359
    invoke-direct {p0, p1, v0}, Landroid/view/HardwareRenderer$GlRenderer;->buildDisplayList(Landroid/view/View;Landroid/view/HardwareCanvas;)Landroid/view/DisplayList;
    ...
    .local v4, status:I
    :try_start_0
    invoke-direct {p0, p4}, Landroid/view/HardwareRenderer$GlRenderer;->prepareFrame(Landroid/graphics/Rect;)I
    ...
    .line 1371
    invoke-direct {p0, p2, v0, v1, v4}, Landroid/view/HardwareRenderer$GlRenderer;->drawDisplayList(Landroid/view/View$AttachInfo;Landroid/view/HardwareCanvas;Landroid/view/DisplayList;I)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 1381
    iput-boolean v8, p1, Landroid/view/View;->mRecreateDisplayList:Z

    .line 1383
    iget-wide v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mFrameCount:J

    add-long/2addr v6, v9

    iput-wide v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mFrameCount:J

    .line 1385
    invoke-direct {p0, p4, v0}, Landroid/view/HardwareRenderer$GlRenderer;->debugDirtyRegions(Landroid/graphics/Rect;Landroid/view/HardwareCanvas;)V

    .line 1386
    invoke-virtual {p0, p2}, Landroid/view/HardwareRenderer$GlRenderer;->drawProfileData(Landroid/view/View$AttachInfo;)V
    ...
    .line 1391
    invoke-direct {p0, v4}, Landroid/view/HardwareRenderer$GlRenderer;->swapBuffers(I)V
    ...
    .restart local v5       #surfaceState:I
    :cond_4
    :try_start_1
    ...
    const-string v7, "An error has occurred while drawing:"
    ...
    .line 1383
    iget-wide v7, p0, Landroid/view/HardwareRenderer$GlRenderer;->mFrameCount:J

    add-long/2addr v7, v9

    iput-wide v7, p0, Landroid/view/HardwareRenderer$GlRenderer;->mFrameCount:J
...
.method initialize(Landroid/view/Surface;)Z
    ...
    iget-object v4, p0, Landroid/view/HardwareRenderer$GlRenderer;->mName:Ljava/lang/String;

    invoke-virtual {v3, v4}, Landroid/view/HardwareCanvas;->setName(Ljava/lang/String;)V
...
.method loadSystemProperties(Landroid/view/Surface;)Z
    ...
    .line 839
    .local v0, changed:Z
    const-string v6, "debug.hwui.profile"
    ...
    .line 840
    .local v4, profiling:Ljava/lang/String;
    sget-object v6, Landroid/view/HardwareRenderer$GlRenderer;->VISUALIZERS:[Ljava/lang/String;
    ...
    .local v5, value:Z
    :goto_0
    iget v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileVisualizerType:I
    ...
    iput-object v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileShapes:[[F

    .line 848
    iput-object v7, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfilePaint:Landroid/graphics/Paint;

    .line 850
    if-eqz v5, :cond_3

    .line 851
    new-instance v6, Landroid/view/HardwareRenderer$GlRenderer$DrawPerformanceDataProvider;

    invoke-direct {v6, p0, v1}, Landroid/view/HardwareRenderer$GlRenderer$DrawPerformanceDataProvider;-><init>(Landroid/view/HardwareRenderer$GlRenderer;I)V

    iput-object v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mDebugDataProvider:Landroid/view/HardwareRenderer$GraphDataProvider;
    ...
    .line 865
    iput-boolean v5, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileEnabled:Z
    ...
    const-string v7, "Profiling hardware renderer"

    invoke-static {v6, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 870
    const-string v6, "debug.hwui.profile.maxframes"
    ...
    .line 872
    .local v3, maxProfileFrames:I
    mul-int/lit8 v6, v3, 0x3

    new-array v6, v6, [F

    iput-object v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileData:[F
    ...
    iget-object v7, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileData:[F

    add-int/lit8 v9, v2, 0x1

    iget-object v10, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileData:[F
    ...
    .end local v2           #i:I
    .end local v3           #maxProfileFrames:I
    ...
    :cond_3
    iput-object v7, p0, Landroid/view/HardwareRenderer$GlRenderer;->mDebugDataProvider:Landroid/view/HardwareRenderer$GraphDataProvider;

    goto :goto_1

    .line 877
    .restart local v2       #i:I
    .restart local v3       #maxProfileFrames:I
    :cond_4
    new-instance v6, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v6}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileLock:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iput v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileCurrentFrame:I

    .line 887
    :cond_5
    const-string v6, "debug.hwui.show_dirty_regions"
    ...
    .line 888
    iget-boolean v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mDebugDirtyRegions:Z
    ...
    .line 890
    iput-boolean v5, p0, Landroid/view/HardwareRenderer$GlRenderer;->mDebugDirtyRegions:Z
    ...
    const-string v7, "Debugging dirty regions"

    invoke-static {v6, v7}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 897
    :cond_6
    const-string v6, "debug.hwui.show_overdraw"
    ...
    .line 899
    iget-boolean v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mShowOverdraw:Z
    ...
    .line 901
    iput-boolean v5, p0, Landroid/view/HardwareRenderer$GlRenderer;->mShowOverdraw:Z
    ...
    .line 879
    :cond_9
    iput-object v7, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileData:[F

    .line 880
    iput-object v7, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileLock:Ljava/util/concurrent/locks/ReentrantLock;

    .line 881
    const/4 v6, -0x1

    iput v6, p0, Landroid/view/HardwareRenderer$GlRenderer;->mProfileVisualizerType:I
