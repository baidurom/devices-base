...
.method private dispatchTransformedTouchEvent(Landroid/view/MotionEvent;ZLandroid/view/View;I)Z
    ...
    const-string v8, "Dispatch transformed touch event with no pointers in it."
...
.method private removeViewInternal(ILandroid/view/View;)V
    ...
    invoke-virtual {p0, v1}, Landroid/view/View;->needGlobalAttributesUpdate(Z)V
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 2717
    .local v61, transformToApply:Landroid/view/animation/Transformation;
    ...
    .line 2725
    .local v39, hardwareAccelerated:Z
    const v6, 0x8000
    ...
    .end local v39           #hardwareAccelerated:Z
    .end local v46           #layerType:I
    :cond_6
    const/16 v46, 0x0
    ...
    .line 2730
    .restart local v39       #hardwareAccelerated:Z
    .restart local v46       #layerType:I
    :cond_7
    if-nez v46, :cond_8
    ...
    .line 2741
    .restart local v29       #caching:Z
    .restart local v43       #initialized:Z
    :cond_a
    const/high16 v6, 0x3f80
    ...
    invoke-virtual {v0, v1, v2, v6, v7}, Landroid/view/View;->invalidate(IIII)V
    ...
    .line 2795
    .end local v42           #hasTransform:Z
    .end local v62           #transformType:I
    :cond_12
    const/4 v6, 0x0
    ...
    .line 2875
    invoke-virtual/range {v61 .. v61}, Landroid/view/animation/Transformation;->getMatrix()Landroid/graphics/Matrix;
    ...
    .line 2880
    :cond_1c
    invoke-virtual/range {v61 .. v61}, Landroid/view/animation/Transformation;->getAlpha()F

    move-result v60

    .line 2881
    .local v60, transformAlpha:F
    const/high16 v6, 0x3f80

    cmpg-float v6, v60, v6
    ...
    .line 2887
    .end local v60           #transformAlpha:F
    :cond_1d
    if-nez v31, :cond_1e
    ...
    .line 2894
    .end local v58           #transX:I
    .end local v59           #transY:I
    :cond_1e
    const/high16 v6, 0x3f80
    ...
    .end local v53           #scrollX:I
    .end local v54           #scrollY:I
    :cond_21
    :goto_11
    and-int/lit8 v6, v38, 0x1
    ...
    .line 2948
    .local v44, layer:Landroid/view/HardwareLayer;
    if-eqz v44, :cond_35

    invoke-virtual/range {v44 .. v44}, Landroid/view/HardwareLayer;->isValid()Z
    ...
    .line 2961
    .end local v44           #layer:Landroid/view/HardwareLayer;
    :cond_24
    :goto_13
    if-nez v45, :cond_25
    ...
    .end local v40           #hasDisplayList:Z
    .end local v41           #hasNoCache:Z
    .end local v49           #offsetForScroll:Z
    .end local v50           #restoreTo:I
    .end local v55           #sx:I
    .end local v56           #sy:I
    :cond_29
    const/4 v6, 0x0
    ...
    .restart local v40       #hasDisplayList:Z
    .restart local v55       #sx:I
    .restart local v56       #sy:I
    :cond_2a
    ...
    .line 2844
    .restart local v41       #hasNoCache:Z
    :cond_2c
    const/16 v49, 0x0
    ...
    .line 2851
    .restart local v49       #offsetForScroll:Z
    .restart local v50       #restoreTo:I
    :cond_2d
    move/from16 v0, v32
    ...
    .line 2953
    .restart local v44       #layer:Landroid/view/HardwareLayer;
    .restart local v45       #layerRendered:Z
    :cond_35
    if-eqz v40, :cond_36
    ...
    :try_end_0
    .catch Landroid/view/GLES20Canvas$InvalidDrawException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 2978
    .local v37, e:Landroid/view/GLES20Canvas$InvalidDrawException;
    ...
    iget-object v6, v6, Landroid/view/View$AttachInfo;->mRootView:Landroid/view/View;

    invoke-virtual {v6}, Landroid/view/View;->debug()V

    .line 2980
    new-instance v6, Landroid/view/GLES20Canvas$InvalidDrawException;

    invoke-direct {v6}, Landroid/view/GLES20Canvas$InvalidDrawException;-><init>()V

    throw v6

    .line 2984
    .end local v37           #e:Landroid/view/GLES20Canvas$InvalidDrawException;
    .end local v45           #layerRendered:Z
    :cond_3a
    if-eqz v27, :cond_25
