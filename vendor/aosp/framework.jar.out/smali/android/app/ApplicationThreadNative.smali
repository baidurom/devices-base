...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .end local v81           #finished:Z
    .end local v104           #userLeaving:Z
    :cond_0
    const/16 v81, 0x0
    ...
    .line 334
    .local v95, proxy:Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v91

    .line 335
    .local v91, port:Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .end local v91           #port:Ljava/lang/String;
    .end local v95           #proxy:Ljava/lang/String;
    :pswitch_19
    const-string v5, "android.app.IApplicationThread"
    ...
    .line 349
    .local v80, fd:Landroid/os/ParcelFileDescriptor;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readStrongBinder()Landroid/os/IBinder;

    move-result-object v99

    .line 350
    .local v99, service:Landroid/os/IBinder;
    ...
    .line 352
    invoke-virtual/range {v80 .. v80}, Landroid/os/ParcelFileDescriptor;->getFileDescriptor()Ljava/io/FileDescriptor;
    ...
    .line 354
    :try_start_0
    invoke-virtual/range {v80 .. v80}, Landroid/os/ParcelFileDescriptor;->close()V
    :try_end_0
    ...
    .end local v80           #fd:Landroid/os/ParcelFileDescriptor;
    .end local v99           #service:Landroid/os/IBinder;
    :pswitch_1b
    const-string v5, "android.app.IApplicationThread"
    ...
    .line 364
    .restart local v80       #fd:Landroid/os/ParcelFileDescriptor;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readStrongBinder()Landroid/os/IBinder;

    move-result-object v99

    .line 365
    .restart local v99       #service:Landroid/os/IBinder;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readStringArray()[Ljava/lang/String;
    ...
    .line 412
    .local v93, profileType:I
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v89

    .line 413
    .local v89, path:Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 410
    .end local v80           #fd:Landroid/os/ParcelFileDescriptor;
    .end local v89           #path:Ljava/lang/String;
    .end local v93           #profileType:I
    .end local v103           #start:Z
    :cond_1b
    const/16 v103, 0x0
    ...
    .line 413
    .restart local v89       #path:Ljava/lang/String;
    .restart local v93       #profileType:I
    .restart local v103       #start:Z
    :cond_1c
    const/16 v80, 0x0
    ...
    .line 449
    new-instance v86, Landroid/os/Debug$MemoryInfo;

    invoke-direct/range {v86 .. v86}, Landroid/os/Debug$MemoryInfo;-><init>()V

    .line 450
    .local v86, mi:Landroid/os/Debug$MemoryInfo;
    move-object/from16 v0, p0
    ...
    .line 458
    .end local v86           #mi:Landroid/os/Debug$MemoryInfo;
    :pswitch_24
    const-string v5, "android.app.IApplicationThread"
    ...
    .line 461
    .local v88, packages:[Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 467
    .end local v77           #cmd:I
    .end local v88           #packages:[Ljava/lang/String;
    :pswitch_25
    const-string v5, "android.app.IApplicationThread"
    ...
    .line 469
    .local v87, msg:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 475
    .end local v87           #msg:Ljava/lang/String;
    :pswitch_26
    const-string v5, "android.app.IApplicationThread"
    ...
    .line 489
    .local v92, prefix:Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readStringArray()[Ljava/lang/String;
    ...
    .end local v80           #fd:Landroid/os/ParcelFileDescriptor;
    .end local v92           #prefix:Ljava/lang/String;
    :pswitch_28
    const-string v5, "android.app.IApplicationThread"
    ...
    .line 503
    .local v100, settings:Landroid/os/Bundle;
    move-object/from16 v0, p0
    ...
    .line 508
    .end local v100           #settings:Landroid/os/Bundle;
    :pswitch_29
    const-string v5, "android.app.IApplicationThread"
    ...
    .line 510
    .local v90, pkg:Ljava/lang/String;
    sget-object v5, Landroid/content/res/CompatibilityInfo;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .end local v90           #pkg:Ljava/lang/String;
    :pswitch_2a
    const-string v5, "android.app.IApplicationThread"
    ...
    .line 530
    .restart local v86       #mi:Landroid/os/Debug$MemoryInfo;
    if-eqz v80, :cond_20
    ...
    .line 590
    .local v94, provider:Landroid/os/IBinder;
    move-object/from16 v0, p0
    ...
    .line 597
    .end local v94           #provider:Landroid/os/IBinder;
    :pswitch_2f
    const-string v5, "android.app.IApplicationThread"
    ...
    .line 600
    .local v97, requestToken:Landroid/os/IBinder;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I

    move-result v98

    .line 601
    .local v98, requestType:I
    move-object/from16 v0, p0
    ...
    .end local v97           #requestToken:Landroid/os/IBinder;
    .end local v98           #requestType:I
    .restart local v41       #args:[Ljava/lang/String;
    .restart local v80       #fd:Landroid/os/ParcelFileDescriptor;
    .restart local v99       #service:Landroid/os/IBinder;
    :catch_0
    ...
    .restart local v92       #prefix:Ljava/lang/String;
    :catch_2
    move-exception v5
