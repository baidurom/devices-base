...
.method private connectToSupplicant()Z
    ...
    #getter for: Landroid/net/wifi/WifiMonitor;->mIsHotspot:Z
    invoke-static {v3}, Landroid/net/wifi/WifiMonitor;->access$300(Landroid/net/wifi/WifiMonitor;)Z

    move-result v3

    invoke-static {v3}, Landroid/net/wifi/WifiNative;->connectToSupplicant(Z)Z
...
.method public run()V
    ...
    .line 382
    :cond_b
    const-string v6, "WPS-NO-OVERLAP"
    ...
    .line 384
    :cond_c
    const-string v6, "WPS-AP-AVAILABLE-PIN"
    ...
    .line 386
    :cond_d
    const-string v6, "WPS-AP-AVAILABLE-PBC"
    ...
    .line 388
    :cond_e
    const-string v6, "WPS-CRED-RECEIVED"
    ...
    const-string v7, "No match event"
    ...
    .end local v0           #event:I
    :cond_1d
    const-string v6, "NO-SUITABLE-AP-FOUND"
