...
.method static synthetic access$11500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$12200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$12300(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pDevice;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$12302(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pDevice;)Landroid/net/wifi/p2p/WifiP2pDevice;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private connect(Landroid/net/wifi/p2p/WifiP2pConfig;Z)I
    ...
    iget-object v10, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mSavedPeerConfig:Landroid/net/wifi/p2p/WifiP2pConfig;
    ...
    .line 2425
    iget-object v9, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mPeers:Landroid/net/wifi/p2p/WifiP2pDeviceList;
    ...
    const-string/jumbo v7, "target device not found "
    ...
    .line 2431
    .restart local v1       #dev:Landroid/net/wifi/p2p/WifiP2pDevice;
    .restart local v2       #isResp:Z
    :cond_3
    ...
    .line 2432
    .local v3, join:Z
    iget-object v9, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mWifiNative:Landroid/net/wifi/WifiNative;

    iget-object v10, v1, Landroid/net/wifi/p2p/WifiP2pDevice;->deviceAddress:Ljava/lang/String;

    invoke-virtual {v9, v10}, Landroid/net/wifi/WifiNative;->p2pGetSsid(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v10, "target ssid is "
    ...
    invoke-direct {p0, v9}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->logd(Ljava/lang/String;)V
    ...
    .line 2436
    const-string/jumbo v9, "target device reaches group limit."
    ...
    .line 2453
    const-string/jumbo v6, "target device reaches the device limit."
    ...
    .line 2442
    iget-object v9, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->mGroups:Landroid/net/wifi/p2p/WifiP2pGroupList;

    iget-object v10, v1, Landroid/net/wifi/p2p/WifiP2pDevice;->deviceAddress:Ljava/lang/String;

    invoke-virtual {v9, v10, v5}, Landroid/net/wifi/p2p/WifiP2pGroupList;->getNetworkId(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v6, v4}, Landroid/net/wifi/WifiNative;->p2pGroupAdd(I)Z
    ...
    invoke-virtual {v9, v10}, Landroid/net/wifi/p2p/WifiP2pGroupList;->getOwnerAddr(I)Ljava/lang/String;
    ...
    invoke-direct {p0, v8}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->getNetworkIdFromClientList(Ljava/lang/String;)I
    ...
    const-string/jumbo v9, "netId related with "
    ...
    iput v4, v6, Landroid/net/wifi/p2p/WifiP2pConfig;->netId:I
    ...
    .line 2477
    :cond_a
    const-string/jumbo v8, "p2pReinvoke() failed, update networks"
    ...
    invoke-direct {p0, v8}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->updatePersistentNetworks(Z)V
    ...
    invoke-virtual {v8, p1, v6}, Landroid/net/wifi/WifiNative;->p2pConnectThoughBssid(Landroid/net/wifi/p2p/WifiP2pConfig;Z)Ljava/lang/String;
...
.method private handleGroupCreationFailure()V
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService;->access$8300(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    invoke-static {v0, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$8302(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    invoke-static {v0, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$8102(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
...
.method private handleGroupRemoved()V
    ...
    invoke-static {v5}, Landroid/net/wifi/p2p/WifiP2pService;->access$11900(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    invoke-static {v5, v7}, Landroid/net/wifi/p2p/WifiP2pService;->access$11902(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
    ...
    invoke-static {v5}, Landroid/net/wifi/p2p/WifiP2pService;->access$10400(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/net/DhcpStateMachine;
    ...
    invoke-static {v5, v8}, Landroid/net/wifi/p2p/WifiP2pService;->access$10402(Landroid/net/wifi/p2p/WifiP2pService;Landroid/net/DhcpStateMachine;)Landroid/net/DhcpStateMachine;
...
.method private sendP2pConnectionChangedBroadcast(Landroid/net/wifi/p2p/WifiP2pService$P2pStatus;)V
    ...
    const-string v2, "[kenping] sending p2p connection changed broadcast, reason = "
