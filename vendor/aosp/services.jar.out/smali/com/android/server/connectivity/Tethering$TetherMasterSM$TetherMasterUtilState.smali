...
.method protected chooseUpstreamType(Z)V
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/server/connectivity/Tethering;->access$100(Lcom/android/server/connectivity/Tethering;)Ljava/lang/Object;
    ...
    const-string v26, "chooseUpstreamType has upstream iface types:"
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/server/connectivity/Tethering;->access$5200(Lcom/android/server/connectivity/Tethering;)Ljava/util/Collection;
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->OPTR:Ljava/lang/String;
    invoke-static/range {v24 .. v24}, Lcom/android/server/connectivity/Tethering;->access$2600(Lcom/android/server/connectivity/Tethering;)Ljava/lang/String;

    move-result-object v24

    const-string v26, "OP03"
    ...
    .line 1510
    .local v14, isSimAbsent:Z
    const/4 v13, 0x0

    .line 1512
    .local v13, isGPRSDisabled:Z
    :try_start_2
    move-object/from16 v0, p0
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/server/connectivity/Tethering;->access$3700(Lcom/android/server/connectivity/Tethering;)Landroid/net/IConnectivityManager;

    move-result-object v24

    invoke-interface/range {v24 .. v24}, Landroid/net/IConnectivityManager;->getActiveNetworkInfo()Landroid/net/NetworkInfo;
    ...
    const-string v26, "Wifi is connected, FeatureOption.MTK_GEMINI_SUPPORT=true"
    ...
    .line 1516
    const-string v24, "gsm.sim.inserted"
    ...
    const-string v27, "isSimInserted="
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/server/connectivity/Tethering;->access$600(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    ...
    .line 1524
    .local v4, currentDataConnectionMultiSimId:J
    move-object/from16 v0, p0
    ...
    invoke-static {v0, v4, v5}, Landroid/provider/Telephony$SIMInfo;->getSlotById(Landroid/content/Context;J)I
    ...
    const-string v27, ", isGPRSDisabled="
    ...
    .line 1584
    .end local v4           #currentDataConnectionMultiSimId:J
    .end local v12           #info:Landroid/net/NetworkInfo;
    .end local v13           #isGPRSDisabled:Z
    .end local v14           #isSimAbsent:Z
    .end local v15           #isSimInserted:I
    ...
    invoke-static/range {v26 .. v26}, Lcom/android/server/connectivity/Tethering;->access$5300(Lcom/android/server/connectivity/Tethering;)I
    ...
    invoke-virtual/range {v24 .. v27}, Lcom/android/internal/util/StateMachine;->sendMessageDelayed(IJ)V

    .line 1636
    .end local v21           #tryAgainLater:Z
    :cond_6
    :goto_3
    move-object/from16 v0, p0
    ...
    .line 1528
    .restart local v4       #currentDataConnectionMultiSimId:J
    .restart local v12       #info:Landroid/net/NetworkInfo;
    .restart local v13       #isGPRSDisabled:Z
    .restart local v14       #isSimAbsent:Z
    .restart local v15       #isSimInserted:I
    ...
    .line 1548
    .local v18, networkInterface:Ljava/lang/String;
    const-string v24, "Tethering"
    ...
    const-string v27, "interface of ConnectivityManager.TYPE_MOBILE_HIPRI: "
    ...
    .end local v18           #networkInterface:Ljava/lang/String;
    :catch_0
    move-exception v9
    ...
    const-string v27, "Wifi is prefered, old upType = "
    ...
    const-string v27, ", new upType is WIFI"
    ...
    const-string v27, "Failed to getActiveNetworkInfo: "
    ...
    .line 1610
    .restart local v16       #linkProperties:Landroid/net/LinkProperties;
    :try_start_b
    move-object/from16 v0, p0
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/server/connectivity/Tethering;->access$3200(Lcom/android/server/connectivity/Tethering;)[Ljava/lang/String;
    ...
    .line 1620
    .local v23, v4Dnses:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/net/InetAddress;>;"
    ...
    .line 1626
    invoke-static/range {v23 .. v23}, Landroid/net/NetworkUtils;->makeStrings(Ljava/util/Collection;)[Ljava/lang/String;

    move-result-object v7

    .line 1630
    .end local v23           #v4Dnses:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/net/InetAddress;>;"
    :cond_f
    :try_start_c
    move-object/from16 v0, p0
    ...
    invoke-static/range {v24 .. v24}, Lcom/android/server/connectivity/Tethering;->access$2300(Lcom/android/server/connectivity/Tethering;)Landroid/os/INetworkManagementService;
    ...
    invoke-static/range {v25 .. v25}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$4400(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/internal/util/State;

    move-result-object v25

    #calls: Lcom/android/internal/util/StateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static/range {v24 .. v25}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5400(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/internal/util/IState;)V
...
.method protected turnOffMasterTetherSettings()Z
    ...
    invoke-static {v2}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5000(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/internal/util/State;

    move-result-object v2

    #calls: Lcom/android/internal/util/StateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v1, v2}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$5100(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/internal/util/IState;)V
    ...
    invoke-static {v3}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$4600(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)Lcom/android/internal/util/State;

    move-result-object v3

    #calls: Lcom/android/internal/util/StateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v2, v3}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$4700(Lcom/android/server/connectivity/Tethering$TetherMasterSM;Lcom/android/internal/util/IState;)V
...
.method protected turnOnMasterTetherSettings()Z
    ...
    invoke-static {v4}, Lcom/android/server/connectivity/Tethering;->access$3100(Lcom/android/server/connectivity/Tethering;)V
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mDefaultDnsServers:[Ljava/lang/String;
    invoke-static {v5}, Lcom/android/server/connectivity/Tethering;->access$3200(Lcom/android/server/connectivity/Tethering;)[Ljava/lang/String;
...
.method protected turnOnUpstreamMobileConnection(I)Z
    ...
    #getter for: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->mMobileApnReserved:I
    invoke-static {v6}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$3600(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)I
    ...
    const-string v6, "[MSM_TetherModeAlive] Try to startUsingNetworkFeature"
    ...
    #getter for: Lcom/android/server/connectivity/Tethering;->mConnService:Landroid/net/IConnectivityManager;
    invoke-static {v5}, Lcom/android/server/connectivity/Tethering;->access$3700(Lcom/android/server/connectivity/Tethering;)Landroid/net/IConnectivityManager;
    ...
    const-string v7, "[MSM_TetherModeAlive] startUsingNetworkFeature result="
    ...
    const-string v7, "[MSM_TetherModeAlive] Failed to startUsingNetworkFeature: "
    ...
    #setter for: Lcom/android/server/connectivity/Tethering$TetherMasterSM;->mMobileApnReserved:I
    invoke-static {v5, p1}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$3602(Lcom/android/server/connectivity/Tethering$TetherMasterSM;I)I
    ...
    invoke-static {v5}, Lcom/android/server/connectivity/Tethering$TetherMasterSM;->access$3804(Lcom/android/server/connectivity/Tethering$TetherMasterSM;)I
    ...
    invoke-virtual {v5, v2, v6, v7}, Lcom/android/internal/util/StateMachine;->sendMessageDelayed(Landroid/os/Message;J)V
    ...
    const-string v6, "[MSM_TetherModeAlive] obtainMsg err"
