...
.method private final finishCurrentActivityLocked(Lcom/android/server/am/ActivityRecord;II)Lcom/android/server/am/ActivityRecord;
    ...
    const-string v2, "ACT-IDLE_NOW_MSG from finishCurrentActivityLocked for mStoppingActivities.size() > 3"
    ...
    const-string v4, "Moving to FINISHING: "
    ...
    invoke-virtual {p0, p1, v5, v5, v2}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)Z
    ...
    const-string v3, "finish the activity - FLAG_ACTIVITY_NO_HISTORY"

    invoke-static {v2, v3}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 3712
    const-string v2, "finish-after-pause"
    ...
    const-string v4, "Enqueueing pending finish: "
...
.method private final stopActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {p0, v1, v5, v4, v2}, Lcom/android/server/am/ActivityStack;->requestFinishActivityLocked(Landroid/os/IBinder;ILandroid/content/Intent;Ljava/lang/String;)Z
    ...
    .line 3277
    sget-boolean v1, Lcom/android/server/am/ActivityStack;->DEBUG_VISBILITY:Z
...
.method final activityIdleInternal(Landroid/os/IBinder;ZLandroid/content/res/Configuration;)Lcom/android/server/am/ActivityRecord;
    ...
    .line 3372
    iget-object v2, v4, Lcom/android/server/am/ActivityRecord;->realActivity:Landroid/content/ComponentName;

    invoke-virtual {v2}, Landroid/content/ComponentName;->getClassName()Ljava/lang/String;

    move-result-object v2

    const-string v3, "com.android.deskclock.AlarmAlertFullScreen"
    ...
    const-string v3, "com.lenovomobile.deskclock.AlarmAlertFullScreen"
    ...
    const-string v3, "com.lenovo.app.Calendar.EventAlert"
    ...
    const-string v3, "reset mAlarmBoot & remove IPOWin"
    ...
    iput-boolean v3, v2, Lcom/android/server/am/ActivityManagerService;->mAlarmBoot:Z
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/am/ActivityManagerService;->removeIPOWin(Landroid/content/Context;)V
...
.method final destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)Z
    ...
    const-string v8, "ACT-Removing activity: token="
...
.method final ensureActivityConfigurationLocked(Lcom/android/server/am/ActivityRecord;I)Z
    ...
    const-string v7, "Switch is destroying non-running "
    ...
    const-string v6, "Switch is skipping already pausing "
    ...
    const-string v7, "Switch is restarting resumed "
    ...
    const-string v6, "Switch is restarting non-resumed "
...
.method final finishActivityLocked(Lcom/android/server/am/ActivityRecord;IILandroid/content/Intent;Ljava/lang/String;)Z
    ...
    const-string v5, "ACT-AM_FINISH_ACTIVITY "
    ...
    const-string v5, "Finish not pausing: "
...
.method public getTaskAccessInfoLocked(IZ)Lcom/android/server/am/TaskAccessInfo;
    ...
    .line 4255
    new-instance v9, Lcom/android/server/am/ActivityStack$3;

    invoke-direct {v9, p0, v8}, Lcom/android/server/am/ActivityStack$3;-><init>(Lcom/android/server/am/ActivityStack;Lcom/android/server/am/TaskAccessInfo;)V
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {v6, v7, v9}, Lcom/android/server/wm/WindowManagerService;->prepareAppTransition(IZ)V
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    .line 1371
    new-instance v2, Lcom/android/server/am/ActivityStack$2;

    const-string v3, "executeAppTransition"

    move-object/from16 v0, p0

    invoke-direct {v2, v0, v3}, Lcom/android/server/am/ActivityStack$2;-><init>(Lcom/android/server/am/ActivityStack;Ljava/lang/String;)V

    invoke-virtual {v2}, Lcom/android/server/am/ActivityStack$2;->start()V
...
.method final startActivityUncheckedLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;[Landroid/net/Uri;IZZ)I
    ...
    sget-boolean v5, Lcom/android/server/am/ActivityStack;->DEBUG_TASKS:Z
    ...
    const-string v7, "launchFlags(original): 0x"
    ...
    iget v7, v0, Lcom/android/server/am/ActivityRecord;->launchMode:I

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v7, ", onlyIfNeeded: "
    ...
    const-string v7, "ACT-launchFlags(original): 0x"
    ...
    .line 2537
    sget-boolean v5, Lcom/android/server/am/ActivityStack;->DEBUG_USER_LEAVING:Z
    ...
    const-string v7, "startActivity() => mUserLeaving="
    ...
    iget-boolean v7, v0, Lcom/android/server/am/ActivityStack;->mUserLeaving:Z
    ...
    const-string v7, "launchFlags(update): 0x"
    ...
    const-string v7, "START_RETURN_INTENT_TO_CALLER, doResume = "
    ...
    const-string v7, "START_TASK_TO_FRONT, doResume = "
    ...
    const-string v7, "ACT-AM_NEW_INTENT "
    ...
    const-string v6, "since different intents, start new activity..."
    ...
    const-string v6, "place the new activity on top oc the current task..."
    ...
    const-string v7, "Starting new activity "
    ...
    const-string v7, " in existing task "
    ...
    const-string v7, " in new guessed "
    ...
    const-string v7, "ACT-AM_CREATE_TASK "
    ...
    const-string v7, "ACT-AM_CREATE_ACTIVITY "
