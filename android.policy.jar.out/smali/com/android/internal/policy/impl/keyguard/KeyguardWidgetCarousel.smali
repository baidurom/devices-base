...
.method private getTransformForPage(II[F)V
    ...
    invoke-virtual {p0, p1, v1, p2}, Lcom/android/internal/policy/impl/keyguard/PagedView;->getBoundedScrollProgress(ILandroid/view/View;I)F
...
.method animatePagesToCarousel()V
    ...
    invoke-virtual {v0, v11}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->getWidgetPageAt(I)Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;
...
.method animatePagesToNeutral()V
    ...
    .line 169
    invoke-virtual {p0, v6}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->getWidgetPageAt(I)Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetFrame;
...
.method public getAlphaForPage(IIZ)F
    ...
    :goto_1
    invoke-virtual {p0, p1, v1, p2}, Lcom/android/internal/policy/impl/keyguard/PagedView;->getScrollProgress(ILandroid/view/View;I)F

    move-result v3

    .line 65
    .local v3, scrollProgress:F
    invoke-virtual {p0, p2, v3}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->isOverScrollChild(IF)Z
...
.method protected screenScrolled(I)V
    ...
    .line 124
    invoke-virtual {p0, v10}, Lcom/android/internal/policy/impl/keyguard/PagedView;->isReordering(Z)Z
    ...
    invoke-virtual {p0, p1, v7, v2}, Lcom/android/internal/policy/impl/keyguard/PagedView;->getScrollProgress(ILandroid/view/View;I)F

    move-result v6

    .line 128
    .local v6, scrollProgress:F
    invoke-virtual {p0, p1, v7, v2}, Lcom/android/internal/policy/impl/keyguard/PagedView;->getBoundedScrollProgress(ILandroid/view/View;I)F
    ...
    .line 132
    invoke-virtual {p0, v2, v6}, Lcom/android/internal/policy/impl/keyguard/KeyguardWidgetPager;->isOverScrollChild(IF)Z
...
.method protected zoomIn(Ljava/lang/Runnable;)Z
    ...
    .line 282
    invoke-super {p0, p1}, Lcom/android/internal/policy/impl/keyguard/PagedView;->zoomIn(Ljava/lang/Runnable;)Z
