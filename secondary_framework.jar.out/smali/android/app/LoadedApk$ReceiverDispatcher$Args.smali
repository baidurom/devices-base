...
.method public run()V
    ...
    .line 725
    invoke-virtual {p0, v3}, Landroid/content/BroadcastReceiver$PendingResult;->sendFinished(Landroid/app/IActivityManager;)V
    ...
    const-string v8, "BDC-Calling onReceive: intent="
    ...
    const-string v8, ", IIntentReceiver="
    ...
    iget-object v8, v8, Landroid/app/LoadedApk$ReceiverDispatcher;->mIIntentReceiver:Landroid/content/IIntentReceiver$Stub;

    invoke-virtual {v8}, Landroid/content/IIntentReceiver$Stub;->asBinder()Landroid/os/IBinder;
