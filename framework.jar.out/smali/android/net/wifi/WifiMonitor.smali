...
.method public stopMonitoring()V
    ...
    const-string/jumbo v2, "stopMonitoring, closeSupplicantConnection for "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Landroid/net/wifi/WifiMonitor;->mCurrentThread:Landroid/net/wifi/WifiMonitor$MonitorThread;

    invoke-virtual {v2}, Landroid/net/wifi/WifiMonitor$MonitorThread;->getName()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Landroid/net/wifi/WifiMonitor$MonitorThread;->getId()J
    ...
    invoke-virtual {v0}, Landroid/net/wifi/WifiMonitor$MonitorThread;->join()V
    :try_end_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v1, "stopMonitoring, it\'s connecting to supplicant!"
    ...
    const-string/jumbo v1, "stopMonitoring, mCurrentThread is null!"
