...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 160
    iput-object v8, p0, Landroid/media/AudioService;->mAudioManager:Landroid/media/AudioManager;
    ...
    iput-object v3, p0, Landroid/media/AudioService;->mRecords:Ljava/util/ArrayList;
    ...
    iput-object v3, p0, Landroid/media/AudioService;->mAudioManager:Landroid/media/AudioManager;
    ...
    invoke-virtual {v2, v3, v4, v6}, Landroid/telephony/TelephonyManager;->listenGemini(Landroid/telephony/PhoneStateListener;II)V
    ...
    invoke-virtual {v2, v3, v4, v9}, Landroid/telephony/TelephonyManager;->listenGemini(Landroid/telephony/PhoneStateListener;II)V
...
.method static synthetic access$6400(Landroid/media/AudioService;)Landroid/media/AudioManager;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$6700()Ljava/lang/Object;
    .locals 1
...
.method static synthetic access$6800(Landroid/media/AudioService;Landroid/os/IBinder;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$6900(Landroid/media/AudioService;)Ljava/util/Stack;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$7102(Landroid/media/AudioService;Landroid/media/IRemoteControlDisplay;)Landroid/media/IRemoteControlDisplay;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private broadcastRingerMode()V
    ...
    const-string v5, "broadcastRingerMode: Ringer mode = "
...
.method private broadcastVibrateSetting(I)V
    ...
    const-string v3, "broadcastVibrateSetting: Type = "
...
.method private createStreamStates()V
    ...
    const-string v6, "createStreamStates numStreamTypes =  "
...
.method private getActiveStreamType(I)I
    ...
    const-string v4, "getActiveStreamType: Forcing STREAM_BLUETOOTH_SCO..."
    ...
    const-string v4, "getActiveStreamType: Forcing STREAM_VOICE_CALL..."
    ...
    const-string v5, "getActiveStreamType: Forcing STREAM_MUSIC..."
    ...
    const-string v4, "getActiveStreamType: Forcing STREAM_FM..."
    ...
    const-string v5, "getActiveStreamType: Forcing STREAM_RING... b/c USE_DEFAULT_STREAM_TYPE..."
    ...
    const-string v5, "getActiveStreamType: Returning suggested type "
    ...
    const-string v4, "getActiveStreamType: Forcing STREAM_NOTIFICATION..."
    ...
    const-string v5, "getActiveStreamType: Forcing STREAM_MUSIC  b/c USE_DEFAULT_STREAM_TYPE..."
...
.method private makeA2dpDeviceUnavailableNow(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "makeA2dpDeviceUnavailableNow"
...
.method private notifyRingerModeChanged()V
    ...
    .line 4151
    :try_start_1
    iget-object v3, v2, Landroid/media/AudioService$Record;->mCallback:Lcom/mediatek/audioprofile/IAudioProfileListener;

    iget v5, p0, Landroid/media/AudioService;->mRingerMode:I

    invoke-interface {v3, v5}, Lcom/mediatek/audioprofile/IAudioProfileListener;->onRingerModeChanged(I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private static sendMsg(Landroid/os/Handler;IIIIILjava/lang/Object;I)V
    ...
    const-string/jumbo v3, "sendMsg: Msg "
...
.method private setRingerModeInt(IZ)V
    ...
    const-string/jumbo v2, "setRingerModeInt: Ringermode = "
...
.method private setStreamVolumeInt(IIZZ)V
    ...
    const-string/jumbo v2, "setStreamVolumeInt: MuteCount != 0, index = "
...
.method public adjustStreamVolume(III)V
    ...
    const-string v8, "adjustStreamVolume: StreamType = "
    ...
    const-string v8, "adjustStreamVolume: AdjustVolume = "
...
.method public listenRingerModeAndVolume(Lcom/mediatek/audioprofile/IAudioProfileListener;I)V
    ...
    .line 4092
    :try_start_3
    iget-object v6, v4, Landroid/media/AudioService$Record;->mCallback:Lcom/mediatek/audioprofile/IAudioProfileListener;

    iget v8, p0, Landroid/media/AudioService;->mRingerMode:I

    invoke-interface {v6, v8}, Lcom/mediatek/audioprofile/IAudioProfileListener;->onRingerModeChanged(I)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
    ...
    .line 4085
    iput-object p1, v4, Landroid/media/AudioService$Record;->mCallback:Lcom/mediatek/audioprofile/IAudioProfileListener;
