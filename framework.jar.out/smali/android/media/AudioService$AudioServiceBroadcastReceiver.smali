...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {v3, v0}, Landroid/media/AudioService;->access$8302(Landroid/media/AudioService;I)I
    ...
    invoke-static {v3, v0, v1, v12}, Landroid/media/AudioService;->access$8400(Landroid/media/AudioService;ZILjava/lang/String;)Z
    ...
    invoke-static {v3, v0}, Landroid/media/AudioService;->access$8500(Landroid/media/AudioService;Landroid/content/Intent;)V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$8700(Landroid/media/AudioService;)Landroid/content/Context;
    ...
    invoke-static {v4, v3}, Landroid/media/AudioService;->access$8602(Landroid/media/AudioService;Landroid/app/KeyguardManager;)Landroid/app/KeyguardManager;
    ...
    invoke-static {v3, v4}, Landroid/media/AudioService;->access$8802(Landroid/media/AudioService;I)I
    ...
    invoke-static {v4}, Landroid/media/AudioService;->access$8900(Landroid/media/AudioService;)Landroid/bluetooth/BluetoothProfile$ServiceListener;
    ...
    invoke-static {v3, v0, v4}, Landroid/media/AudioService;->access$9000(Landroid/media/AudioService;Ljava/lang/String;Z)V
    ...
    invoke-static {v3}, Landroid/media/AudioService;->access$9200(Landroid/media/AudioService;)V
