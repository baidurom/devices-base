...
#-----------------------------------------------------------------------------
vendor_modify_jars := framework framework_ext services pm android.policy
...
# The property decide whether support call record for your device.
# The default value is 1.
# In general, most devices support call record.
# You should configure the property according to your device.
override_property += \
    ro.call.record=1
