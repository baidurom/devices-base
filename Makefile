...
#-----------------------------------------------------------------------------
vendor_saved_apps := MtkBt FMTransmitter FMRadio
...
#-----------------------------------------------------------------------------
vendor_modify_jars := framework secondary_framework services pm android.policy
...
# The base device is A789 which has hardware mainkeys.
